class Admin::ReceptionistsController < ApplicationController
    ...
    def create
      ...
      if @receptionist.save
        ...
        redirect_to new_admin_receptionist_path, alert: @receptionist.errors.full_messages
      end
    end
    ...
    def update
      ...
      if @receptionist.update_attributes(secure_params)
        ...
        redirect_to edit_admin_receptionist_path, alert: @receptionist.errors.full_messages
      end
    end
